...
def main():
    ...
    # Labels
    label_list = [119, 120, 114, 90, 28, 29, 30, 82, 87, 8, 44, 31, 33, 94, 22, 14, 52, 91, 92, 13, 89, 86, 118, 93, 12, 68, 83,
    ...
    logger.info("Done calculating TF-IDF score for eur_lex dataset.")
    ...
    def preprocess_function(examples):
        ...
        batch = tokenizer(
            examples["text"],
            padding=False,
            max_length=False if data_args.full_text else 512,
        ...
        for input_id in batch["input_ids"]:
            ...
            for id_word in input_id:
                n = counts[id_word] * tfidf_vectorizer.idf_[id_word]
                tf_idf = 1 + math.log(n)
