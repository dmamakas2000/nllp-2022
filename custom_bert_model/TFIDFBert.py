...
"""
Custom created class which represents the custom created Bert model
used in order to multiply TF-IDF scores of training datasets with positional embeddings. 
